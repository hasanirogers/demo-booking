<?php
  function business_post_type_hero() {
    $labels = array(
      'name'          => 'Hero Slides', // Plural name
      'singular_name' => 'Hero Slide'   // Singular name
    );
    ...
    $args = array(
      'labels'              => $labels,
      'description'         => 'Hero slides on the homepage.', // Description
      'supports'            => $supports,
  ...
  add_action('init', 'business_post_type_hero');
